...
(async () => {
    ...
    try{
      await page.goto('https://8081-eefcdafabef43426aeddaeceone.ide.exam.ly/');
    ...
    try {        
      await page1.goto('https://8081-eefcdafabef43426aeddaeceone.ide.exam.ly/');
    ...
    try{
      await page2.goto('https://8081-eefcdafabef43426aeddaeceone.ide.exam.ly/Employee/Create');
